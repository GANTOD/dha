...
petik = '```'
fake = '©Gant Botz'//GANTI NAMA KAMU BEP
ban =[]
...
module.exports = dha = async (dha, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = dha.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "Hêrmåñ ßð†z","listType": "SINGLE_SELECT","sections": list}}, {})
...
*Sewa bot?* Chat wa.me/6283146208804`
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: 'Hêrmåñ ßð†z', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
*Cek list Server GTIVD dibawah!*`
       ...
       case 'othercmd':
               ...
               startnum = 0
               for (let x of listmenu) {
               const yy = {title: 'Hêrmåñ ßð†z' + nombor++,
                    rows: [
                       {
                        title: `${listmenuu[startnum++]}`,
                        description: ``,
       ...
       case 'store':
               ...
               const yy = {title: 'List Button Menu' + nombor++,
                    rows: [
                       {
                        title: `${listmenuu[startnum++]}`,
                        footerText: 'Helo Jan lupa Subscribe', imageMessage: imageMsg,
                        rowId: `${prefix}${x}`
                      }
                    ]
                   }
               ...
               listmsg(from, `${ucapanWaktu}`,   `Hêrmåñ ßð†z`, list)
               break
//------------------< Game >------------------- 
        case 'limitgame': 
        case 'balance': 
